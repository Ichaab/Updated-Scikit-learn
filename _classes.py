...
CRITERIA_CLF = {"gini": _criterion.Gini,
                "entropy": _criterion.Entropy, "aecid": _criterion.AECID, "ae": _criterion.AE, "oce":_criterion.OCE, "hd":_criterion.HellingerDistanceCriterion,
"iwe": _criterion.WeightedEntropy}
    ...
    def fit(self, X, y, sample_weight=None, check_input=True,
        ...
        if expanded_class_weight is not None:
            if sample_weight is not None:
				...
				#print("gggg",sample_weight)
				#print("expanded_class_weight=",expanded_class_weight,"\nsample_weight=",sample_weight)
            else:
        ...
        if not isinstance(criterion, Criterion):
            if is_classification:
                criterion = CRITERIA_CLF[self.criterion](self.n_outputs_,
                                                         self.n_classes_, self.prior_dist, self.beta)
            else:
...
class DecisionTreeClassifier(ClassifierMixin, BaseDecisionTree):
    ...
    def __init__(self, *,
                 criterion="gini",
                 prior_dist=np.array([0.9687970222539004,0.031202977746099626]),
                 beta=0.1,
                 splitter="best",
                 max_depth=None,
                 min_samples_split=2,
